...
public class AIInsightServiceImpl implements AIInsightService {
    ...
    public Map<String, Object> getPeakHours() {
        try {
            File file = new File(AI_OUTPUT_PATH + "peak_hours.json");
            return objectMapper.readValue(file, new TypeReference<>() {});
        } catch (Exception e) {
            throw new RuntimeException("Failed to read peak hours AI output", e);
        }
    }
    ...
    public Map<String, String> getFoodDemand() {
        try {
            File file = new File(AI_OUTPUT_PATH + "food_demand.json");
            return objectMapper.readValue(file, new TypeReference<>() {});
        } catch (Exception e) {
            throw new RuntimeException("Failed to read food demand AI output", e);
        }
    }
